										...
										$("#boardList>tbody>tr>td")
												.click(
														function() {
															...
															location.href = 'noticeDetail.co?classNum=${classNum}&cno='
																	+ $(this)
																			.closest(
																					"tr")
																			.find(
				...
				<div id="pagingArea">
					<ul
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a class="page-link"
									href="notice.co?classNum=${ classNum }&cpage=${ pi.currentPage - 1 }">&laquo;</a></li>
							</c:otherwise>
						</c:choose>
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
							<li class="page-item"><a class="page-link"
								href="notice.co?classNum=${ classNum }&cpage=${ p }">${ p }</a></li>
						</c:forEach>
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item"><a class="page-link"
									href="notice.co?classNum=${ classNum }&cpage=${ pi.currentPage + 1 }">&raquo;</a></li>
							</c:otherwise>
						</c:choose>
					</ul>
				</div>
