			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown no-arrow mx-1"><a
					...
					aria-expanded="false"> <i class="fas fa-bell fa-fw"></i>
						<!-- Counter - Alerts --> <span
						class="badge badge-danger badge-counter">543+</span>
				</a> <!-- Dropdown - Alerts -->
					<div
						...
						<a class="dropdown-item d-flex align-items-center" href="#">
							...
							<div>
								...
								<span class="font-weight-bold">A new
									monthly report is ready to download!</span>
							</div>
				...
				<li class="nav-item dropdown no-arrow"><a
					...
					<div
						...
						<a class="dropdown-item" href="#"> <!-- 여기에 마이페이지 링크 걸기--> <i
							class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> 마이페이지로간다
						</a> <a class="dropdown-item" href="#"> <i
							class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> 세팅? 뭔가
							세팅하던 다른곳으로 갈 수 있다.
						</a> <a class="dropdown-item" href="#"> <i
							class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> 마찬가지로 다른
							무엇인가 넣을 수 있다.
						</a>
