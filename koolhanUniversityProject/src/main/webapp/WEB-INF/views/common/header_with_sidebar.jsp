...
<body id="page-top">
	<div id="socketAlert" class="alert alert alert-success" role="alert"
	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				style="height: 150px" href="mainPage.me">
			...
			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link" href="mypage.go"> <i
					class="fa-solid fa-user"></i> <span>회원 정보 조회</span></a></li>
			<c:if test="${loginUser.meType eq 'A' }">
				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link" href="userList.go">
						<i class="fa-solid fa-user"></i> <span>전체 회원 정보 조회</span>
				</a></li>
			</c:if>
			...
			<c:if test="${ not empty loginStudent }">
				...
				<li class="nav-item"><a class="nav-link collapsed" href="#"
					...
					aria-expanded="true" aria-controls="collapseOne"> <i
						class="fa-solid fa-book-open-reader"></i> <span>나의 강의실</span>
				</a>
				...
				<li class="nav-item"><a class="nav-link collapsed" href="#"
					...
					aria-expanded="true" aria-controls="collapseTwo"> <i
						class="fa-solid fa-id-card"></i> <span>마이페이지</span>
				</a>
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
						...
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="update.stu">개인 정보 수정</a><a
								...
								class="collapse-item" href="takeOff.do">휴 · 복학 신청</a> <a
								class="collapse-item" href="takeOffSelect.do">휴 · 복학 신청 조회</a> <a
								class="collapse-item" href="certificate.issue">증명서 발급</a>
						</div>
					</div></li>
			</c:if>
			...
			<c:if test="${ not empty loginUser and loginUser.meType eq 'A' }">
				...
				<li class="nav-item"><a class="nav-link collapsed" href="#"
					...
					aria-expanded="true" aria-controls="collapse2"> <i
						class="fa-solid fa-address-book"></i> <span>교직원 / 학생 등록</span>
				</a>
					<div id="collapse2" class="collapse" aria-labelledby="heading2"
						data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="insertForm.stu">학생 등록</a> <a
								class="collapse-item" href="insertForm.me">교직원 등록</a>
						</div>
					</div></li>

				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link" href="insertForm.no">
						<i class="fa-solid fa-bullhorn"></i> <span>공지사항 등록</span>
				</a></li>

				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link" href="tuitionMake.ad">
						<i class="fa-solid fa-bullhorn"></i> <span>등록금 고지서 생성</span>
				</a></li>

				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link" href="tuitionIssu.ad">
						<i class="fa-solid fa-bullhorn"></i> <span>등록금 고지서 발급</span>
				</a></li>

				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link"
					href="admintakeOffSelect.me"> <i class="fa-solid fa-bullhorn"></i>
						<span>휴학 신청서 조회</span></a></li>
			</c:if>
			<c:if test="${ not empty loginUser and loginUser.meType eq 'P' }">
				...
				<li class="nav-item"><a class="nav-link collapsed" href="#"
					...
					<div id="collapseFour" class="collapse"
						...
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="classEnroll.co">강의 등록</a> <a
								class="collapse-item" href="classList.bo">강의 관리</a>
						</div>
					</div></li>
				...
				<li class="nav-item"><a class="nav-link collapsed" href="#"
					...
					aria-expanded="true" aria-controls="collapseFour"> <i
						class="fa-solid fa-check-to-slot"></i> <span>과제</span>
				</a>
					<div id="collapseSeven" class="collapse"
						aria-labelledby="headingFour" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="professorPJEnrollForm.do">과제
								등록</a> <a class="collapse-item" href="professorPJStateList.do">과제
								현황</a>
						</div>
					</div></li>
				...
				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link"
					href="professorGDEnroll.do"> <i class="fa-solid fa-file-pen"></i>
						<span>성적 등록</span></a></li>
			</c:if>
			...
			<c:if test="${not empty loginStudent}">
				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link" href="list.bo"> <i
						class="fa-solid fa-users"></i> <span>커뮤니티 게시판</span></a></li>

				<!-- Nav Item - Charts -->
				<li class="nav-item"><a class="nav-link" href="library.go">
						<i class="fa-solid fa-book-bookmark"></i> <span>중앙 도서관</span>
				</a></li>
			</c:if>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fa-solid fa-dove"></i> <span>소식</span>
			</a>
				<div id="collapseSix" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="list.no">공지사항</a> <a
							class="collapse-item" href="busApiForm.do">셔틀버스 안내</a> <a
							class="collapse-item" href="job.do">관련 취업 정보</a>
					</div>
				</div></li>
							...
							<li class="nav-item dropdown no-arrow"><a
								...
								aria-expanded="false"> <c:choose>
										<c:when
											...
											<span class="mr-2 d-none d-lg-inline text-gray-600 small">${loginUser.memberName
														}
												교수</span>
											<c:choose>
										...
										<c:when test="${ not empty loginStudent and empty loginUser }">
											<span class="mr-2 d-none d-lg-inline text-gray-600 small">${loginStudent.studentName
														}님</span>
											<c:choose>
								...
								<div
									...
									<a class="dropdown-item" href="mypage.go"> <!-- 여기에 마이페이지 링크 걸기-->
										...
										마이페이지
									</a> <a class="dropdown-item updateInfo" href="#"> <i
										class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> 회원 정보
										수정
									</a>
