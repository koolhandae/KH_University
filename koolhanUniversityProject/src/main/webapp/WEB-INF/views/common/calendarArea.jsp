...
<link href="
https://gcore.jsdelivr.net/npm/@fullcalendar/daygrid@5.8.0/main.min.css
" rel="stylesheet">
<!-- fullcalendar CDN -->
<link
...
<!-- fullcalendar 언어 CDN -->
<script src='https://gcore.jsdelivr.net/npm/fullcalendar@6.0.0/locales-all.min.js'></script> 
...
<body>
	<jsp:include page="../common/header_with_sidebar_calendar.jsp" />
	<div id='calendar'></div>
	<!-- 부트스트랩 모달 일정추가 -->
