                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <br>
                          <span id="testTitle">🔔 자격증일정을 확인하고 일정에 등록해보세요!</span>   
                        </div>   
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                            취소
                          </button>
                          <button type="button" class="btn btn-primary" id="addSch" style="background-color: #1c4587; border-color: #1c4587;">
                            추가
                          </button>
                        </div>
                      </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        // 구글캘린더API 키값
        googleCalendarApiKey : 'AIzaSyB5xwUFTDZKLNkU3CIRj1p2OarqGVjuX48',
        ...
        initialDate: '2024-03-01', // 초기 날짜설정(설정안하면 sysdate)
